...
python main.py --method SAAL --uncertainty Entropy --dataset CIFAR10 --trial 3 --cycle 10 --n-initial 100 --n-query 100 --n-class 10 --epochs 200 --n-drop 5 --imb-factor 0.2 --seed 2
