...
class LL(ALMethod):
    ...
    def get_predloss(self):
        ...
        # unlabeled_subset = torch.utils.data.DataLoader(self.unlabeled_set, batch_size=self.args.test_batch_size, num_workers=self.args.workers)
        with torch.no_grad():
    ...
    def select(self, **kwargs):
        ...
        Q_index = [self.U_index[idx] for idx in selected_idx_sub]
